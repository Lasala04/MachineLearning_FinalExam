...
export default function SVMPage() {
  ...
  return (
    <>
      <Navbar />
      <div className="bg-linear-to-r from-red-600 to-orange-500 text-white py-12 px-6">
      ...
      <main className="min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          {/* GUIDE */}
          <section className="bg-red-50 border-l-4 border-red-500 p-6 rounded-lg mb-8">
            <h2 className="text-2xl font-bold text-red-900 mb-4">📖 How to Use This Tool</h2>
          ...
          <section className="bg-white p-8 rounded-lg shadow-md mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Transaction Amount ($)</label>
                <input
                  type="number"
                  value={amount}
                  onChange={(e) => setAmount(e.target.value)}
                  placeholder="e.g., 500"
                  className="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-red-500 focus:outline-none text-black"
                />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Customer Age</label>
                <input
                  type="number"
                  value={age}
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Days Since Last Purchase</label>
                <input
                  type="number"
            ...
            <div className="space-y-3 mb-6">
              <label className="flex items-center cursor-pointer">
                ...
                />
                <span className="ml-3 text-gray-700 font-bold">⚠️ New Device Used?</span>
              </label>
              <label className="flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-5 h-5 accent-red-600"
                />
                <span className="ml-3 text-gray-700 font-bold">⚠️ Billing/Shipping Address Mismatch?</span>
              </label>
            </div>
            ...
            <button
              ...
              className="w-full bg-linear-to-r from-red-600 to-orange-500 text-white font-bold py-3 rounded-lg hover:opacity-90 disabled:opacity-50 transition"
            >
            ...
            {prediction && (
              <div className={`mt-8 p-6 rounded-lg border-2 ${
                prediction.is_fraud ? 'bg-red-50 border-red-300' : 'bg-green-50 border-green-300'
              }`}>
                <h3 className="text-2xl font-bold mb-4 text-gray-900">🔍 Fraud Analysis Result</h3>
                <div className="grid md:grid-cols-3 gap-6 mb-6">
                  <div>
                    <p className="text-sm text-gray-600">Status</p>
                    <p className={`text-3xl font-bold ${
                      prediction.is_fraud ? 'text-red-600' : 'text-green-600'
                    }`}>
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-bold text-orange-600">{prediction.risk_score}%</p>
                  </div>
                  <div>
                ...
                <p className="text-gray-700 bg-white p-4 rounded border-l-4 border-red-500">
          ...
          {/* HOW IT HELPS */}
          <section className="bg-white p-6 rounded-lg shadow-md mb-6">
            <h2 className="text-2xl font-bold text-purple-700 mb-3">💡 How Support Vector Machine Helps</h2>
