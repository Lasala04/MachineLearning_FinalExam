...
export default function LinearRegressionPage() {
  ...
  return (
    <>
      <Navbar />
      <div className="bg-linear-to-r from-blue-700 via-blue-600 to-cyan-600 text-white py-12 px-6">
        <div className="max-w-4xl mx-auto">
          <Link href="/" className="text-blue-200 hover:text-white mb-4 inline-flex items-center transition">
      ...
      <main className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-950">
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          {/* GUIDE SECTION */}
          <section className="bg-slate-800/50 backdrop-blur-sm border-l-4 border-blue-500 p-6 rounded-lg mb-8">
            <h2 className="text-2xl font-bold text-blue-400 mb-4">📖 How to Use This Tool</h2>
          ...
          <section className="bg-slate-800/50 backdrop-blur-sm p-8 rounded-lg shadow-md mb-8 border border-slate-700">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div>
                <label className="block text-sm font-bold text-slate-300 mb-2">Month 1 Sales ($)</label>
                <input
                  type="number"
                  value={month1}
                  onChange={(e) => setMonth1(e.target.value)}
                  placeholder="e.g., 40000"
                  className="w-full px-4 py-2 border-2 border-slate-600 bg-slate-900 text-white rounded-lg focus:border-blue-500 focus:outline-none"
                />
              </div>
              <div>
                <label className="block text-sm font-bold text-slate-300 mb-2">Month 2 Sales ($)</label>
                <input
                  type="number"
                  value={month2}
              ...
              <div>
                <label className="block text-sm font-bold text-slate-300 mb-2">Month 3 Sales ($)</label>
                <input
                  type="number"
                  value={month3}
            ...
            <button
              ...
              className="w-full bg-linear-to-r from-blue-700 to-cyan-600 text-white font-bold py-3 rounded-lg hover:opacity-90 disabled:opacity-50 transition"
            >
            ...
            {prediction && (
              <div className="mt-8 bg-linear-to-br from-blue-900/40 to-cyan-900/40 border-2 border-blue-500 p-6 rounded-lg">
                <h3 className="text-2xl font-bold text-blue-300 mb-4">📊 Prediction Result</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <p className="text-sm text-slate-400">Predicted Sales</p>
                    <p className="text-4xl font-bold text-blue-400">${prediction.prediction.toLocaleString()}</p>
                  </div>
                  <div>
                    <p className="text-sm text-slate-400">Confidence Level</p>
                    <p className="text-4xl font-bold text-green-400">{prediction.confidence}%</p>
                  </div>
                </div>
                <p className="mt-6 text-slate-300 bg-slate-800/80 p-4 rounded border-l-4 border-blue-500">
          ...
          {/* HOW IT HELPS */}
          <section className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-lg shadow-md mb-6 border border-slate-700">
            <h2 className="text-2xl font-bold text-purple-400 mb-3">💡 How Linear Regression Helps</h2>
            ...
            <div className="bg-blue-900/30 p-4 rounded-lg border-l-4 border-blue-500">
              <h3 className="font-bold text-blue-300 mb-2">Simple Analogy:</h3>
              <p className="text-slate-300">
          ...
          <section className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-lg shadow-md border border-slate-700">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-green-900/30 p-4 rounded-lg border-l-4 border-green-500">
                <h3 className="font-bold text-green-400 mb-2">✅ Reduce Inventory Costs</h3>
                <p className="text-slate-300">Save 25% on storage and holding costs</p>
              </div>
              <div className="bg-green-900/30 p-4 rounded-lg border-l-4 border-green-500">
                <h3 className="font-bold text-green-400 mb-2">✅ Prevent Stockouts</h3>
                <p className="text-slate-300">Never miss sales during peak season</p>
              </div>
              <div className="bg-green-900/30 p-4 rounded-lg border-l-4 border-green-500">
                <h3 className="font-bold text-green-400 mb-2">✅ Improve Cash Flow</h3>
                <p className="text-slate-300">Better planning = healthier finances</p>
              </div>
              <div className="bg-green-900/30 p-4 rounded-lg border-l-4 border-green-500">
                <h3 className="font-bold text-green-400 mb-2">✅ Data-Driven Decisions</h3>
                <p className="text-slate-300">Replace guesswork with science</p>
              </div>
            </div>
          </section>
